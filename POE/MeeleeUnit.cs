...
namespace POE
{
    ...
    class MeeleeUnit : Unit
    {
        ...
        public MeeleeUnit(int X_position, int Y_position, int Health, int Attack, int Speed, int Attack_range, int Faction, string image, string type)
        {
            Xpos = X_position;
            Ypos = Y_position;
            health = Health;
        ...
        {
            return "MU:  " + Xpos + "," + Ypos + "," + Health + "," + Unit_Type ;
        }
